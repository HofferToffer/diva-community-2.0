...
export const CYCLE_PHASE_TIPS: Record<CyclePhaseKey, CycleTip[]> = {
  menstruacna: [
    ...
    { label: "Kofeín a alkohol", category: "eat", icon: Wine, detail: "Kofeínu je dobré uberať, ideálne žiadny alkohol — ak si ho predsa dáš, drž sa aspoň mierneho množstva. Dopraj si jemnosť, menej podráždenosti a napätia v tele." },
  ...
  lutealna: [
    ...
    { label: "Menej kofeínu a alkoholu", category: "eat", icon: Wine, detail: "Kofeínu je dobré uberať, ideálne žiadny alkohol — ak si ho predsa dáš, drž sa aspoň mierneho množstva. Dopraj si jemnosť, menej podráždenosti a napätia v tele." },
    { label: "Jemná joga", category: "move", icon: PersonStanding },
