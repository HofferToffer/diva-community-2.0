...
export const CYCLE_PHASE_TIPS: Record<CyclePhaseKey, CycleTip[]> = {
  menstruacna: [
    ...
    { label: "Kofeín a alkohol", category: "eat", icon: Wine, detail: "Menej kofeínu môže pomôcť lepšiemu tráveniu počas menštruácie. Alkoholu sa najlepšie úplne vyhni — ak si ho predsa dáš, drž sa mierneho množstva." },
  ...
  lutealna: [
    ...
    { label: "Menej kofeínu a alkoholu", category: "eat", icon: Wine, detail: "Kofeínu je dobré uberať, alkoholu sa najlepšie úplne vyhnúť — ak si ho predsa dáš, drž sa mierneho množstva. Dopraj si jemnosť, menej podráždenosti a napätia v tele." },
    { label: "Jemná joga", category: "move", icon: PersonStanding },
