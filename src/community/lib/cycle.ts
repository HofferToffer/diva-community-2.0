...
export const CYCLE_PHASE_TIPS: Record<CyclePhaseKey, CycleTip[]> = {
  menstruacna: [
    ...
    { label: "Jogurt a fermentované jedlá", category: "eat", icon: Milk },
  ...
  folikularna: [
    ...
    { label: "Nová zručnosť", category: "do", icon: NotebookPen },
  ],
  ovulacia: [
    ...
    { label: "Poriadne rozcvičenie", category: "move", icon: Timer },
  ...
  lutealna: [
    ...
    { label: "Extra hydratácia", category: "eat", icon: GlassWater },
    { label: "Jemná joga", category: "move", icon: PersonStanding },
