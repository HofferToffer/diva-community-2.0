...
const CONFETTI = [
  { top: "9%", left: "12%", size: 8, shape: "circle", color: "#E3B9A7" },
  { top: "15%", left: "78%", size: 10, shape: "circle", color: "#A85D42" },
  { top: "24%", left: "24%", size: 6, shape: "circle", color: "#F4ECE3" },
  { top: "19%", left: "67%", size: 7, shape: "square", color: "#E3B9A7" },
  { top: "31%", left: "10%", size: 6, shape: "square", color: "#A85D42" },
  { top: "12%", left: "46%", size: 9, shape: "circle", color: "#F4ECE3" },
] as const;
    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed inset-0 z-[100] overflow-hidden bg-diva-slivkova"
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at 30% 20%, hsl(18 52% 77% / 0.35), transparent 55%), radial-gradient(circle at 75% 75%, hsl(16 44% 46% / 0.35), transparent 55%)",
            }}
          />
          {CONFETTI.map((c, i) => (
            <span
          ...
          <div className="relative flex h-full flex-col items-center justify-center px-8 text-center">
            <motion.div
              ...
              className="flex h-16 w-16 items-center justify-center rounded-full border border-[hsl(40_33%_96%/0.25)] bg-[hsl(40_33%_96%/0.12)] text-3xl shadow-[0_0_28px_2px_hsl(18_52%_77%/0.35)]"
              aria-hidden="true"
            >
              🎂
            </motion.div>

            <p className="mt-5 font-display text-sm uppercase tracking-[0.18em] text-diva-pudrova">
              {t("birthday.kicker", { defaultValue: "Dnes je tvoj deň" })}
            </p>

            <p className="mt-2.5 font-display text-4xl leading-tight text-[hsl(40_33%_96%)]">
              {name
            ...
            <button
              type="button"
              onClick={() => setVisible(false)}
              className="mt-7 rounded-full bg-[hsl(40_33%_96%)] px-7 py-3 text-sm font-medium text-diva-slivkova transition-opacity hover:opacity-90"
            >
